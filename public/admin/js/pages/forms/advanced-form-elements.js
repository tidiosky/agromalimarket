$(function () {
    ...
    //Dollar Money
    $demoMaskedInput.find('.money-dollar').inputmask('99999999999,00 $', { placeholder: '___________,__ $' });
    //Euro Money
    $demoMaskedInput.find('.money-euro').inputmask('99999999999,00 €', { placeholder: '___________,__ €' });
