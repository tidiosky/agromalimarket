...
<head>
    ...
    <title>Modification de mot de passe | AgroMaliMarket - vente en ligne</title>
    <!-- Favicon-->
    ...
    <div class="card">
        <div class="body">
            ...
            <form id="sign_in" method="POST" action="{{ route('password.request') }}">
                ...
                <div class="msg">Modification de votre mot de passe</div>
                <div class="input-group {{ $errors->has('email') ? ' has-error' : '' }}">
                            <span class="input-group-addon">
                            <i class="material-icons">email</i>
                            </span>
                    <div class="form-line">
                        <input type="email" class="form-control" value="{{ $email ?? old('email') }}" autofocus name="email" placeholder="Votre adresse mail"
                               required>
                    </div>
                ...
                <div class="row m-t-15 m-b--20">
                    ...
                    <div class="col-xs-6 align-right">
                        <a href="{{ route('login') }}"><i class="material-icons">lock_open</i> Connectez-vous ?</a>
                    </div>
                </div>
            </form>
        </div>
