            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="row clearfix">
                        ...
                        @endif
                        <form method="POST" action="{{ url('admin/category/create') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('product.category.form', ['formMode' => 'create'])
