...
@endsection
@section('title', "Modification-".$category->name)
@section('content')
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="header">
                    <h2>
                        Edition de  Produit #{{ $category->id }}
                    </h2>
                ...
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <form method="POST" action="{{ route('admin.cat.update', $category->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">

                            {{ csrf_field() }}

                            @include ('product.category.form', ['formMode' => 'edit'])
