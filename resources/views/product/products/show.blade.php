            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <a href="{{ route('admin.pro.edit',$product->id) }}" title="Edit Product">
                            <button  class="btn btn-info btn-circle waves-effect waves-circle waves-float">
                                <i class="material-icons">mode_edit</i>
                            </button>
                        </a>

                        <form method="POST" action="{{ route('admin.pro.destroy',$product->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $loop->iteration or $product->id }}</td>
                                        <td><img src="{{ asset('products/'.$product->filename) }}" style="width: 200px;height: 160px;" alt=""></td>
