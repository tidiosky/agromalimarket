...
@endsection
@section('title', "Modification-".$unity->name)
@section('content')
            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <form method="POST" action="{{ route('admin.unity.update',$unity->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            @include ('product.unity.form', ['formMode' => 'edit'])
                        </form>
                    </div>
                </div>
            </div>
