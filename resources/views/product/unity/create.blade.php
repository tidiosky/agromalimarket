...
@endsection
@section('title',"Création d'unités")
@section('content')
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>Création d'unités</h2>
                ...
                <div class="body">
                    <div class="row clearfix">
                        ...
                        @endif
                        <form method="POST" action="{{ url('admin/unity/create') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('product.unity.form', ['formMode' => 'create'])
